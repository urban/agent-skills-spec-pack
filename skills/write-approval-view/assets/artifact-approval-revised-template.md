...
- In scope:
  - [TODO: what this artifact settles]
- Out of scope:
  - [TODO: what this artifact does not settle]
...
- Approval-view validator:
  - Command: [TODO: bash ./scripts/validate_approval_view.sh artifact-revised <canonical-file> <approval-md> <approval-html>]
  - Result: Passed
